...
function! AddVimVar(key, value)
    let key = a:key
    let value = a:value
    call AppendVimAndExecute('let g:' . key . ' = ' . SingleQuote(value))
endfunction
...
function! AppendToVimFromOtherFile(s)
    ...
    call AppendVimAndExecute(value)
endfunction
...
function! AddVimSimpleDict(dict, key, value)
    ...
    call AppendVimAndExecute(payload)
endfunction
...
function! AddDictItem(...)
    ...
    call AppendVimAndExecute(ToGDict(dict, a, b))
endfunction
